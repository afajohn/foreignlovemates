...
import { getTrashQuery, getPaginationParams, getTrashRecords } from "@/_lib/fetch-trash";
...
export async function GET(request: Request) {
  try {
    ...
    const { totalRecords, totalPages } = await getTrashRecords(sq, ctgy, pt);
    const query = getTrashQuery(pageSize, offset, ctgy, pt);
