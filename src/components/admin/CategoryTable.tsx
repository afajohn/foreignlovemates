                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                              <Button 
                                  ...
                                  onClick={() => router.push(`/afa-admin/categories/category-form?id=${category.category_id}`)}><Pencil /></Button>
                          </TooltipTrigger>
                          ...
                          <Tooltip>
                              <TooltipTrigger asChild>
                                  ...
                                  onClick={(e) => { e.stopPropagation(); handleDeleteClick(category.category_id ?? `${category.category_id}`); }}><Trash2 /> </Button>
                              </TooltipTrigger>
